...
🎯 **Business Intelligence | Software Development | Data Science**

Welcome to my GitHub!  
I’m passionate about combining **business strategy** with **technical innovation** — transforming data and ideas into meaningful digital solutions.
...
`Python (Flask, Django)` • `Java` • `PHP` • `C` • `HTML` • `CSS` • `JavaScript`  

**Databases:**  
`MySQL` • `PostgreSQL`  

**Tools & Platforms:**  
`Git` • `GitHub` • `Bootstrap` • `Talend` • `Jira` • `IBM Cognos Analytics` • `Power BI`

---

## 📈 What I'm Learning  
🌱 Expanding my skills in **machine learning** and **neural networks**.  
💡 Exploring **cybersecurity** and how it intersects with **data science**.
...
⭐️ *“Great communication is the bridge between ideas and impact.”*
